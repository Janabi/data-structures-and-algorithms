...
let biggerThanLuke = (arr) => {
  ...
  let bigger = arr.reduce((acc, value)=>{
...
const detectTicTacToeWin = (board) => {
  ...
  function helpCheck(row1, col1, row2, col2, row3, col3) {
    if ((col1[0] === 'X' && col1[1] === 'X' && col1[2] === 'X') || (col1[0] === 'O' && col1[1] === 'O' && col1[2] === 'O')) {
        return true;
    }
    
    if ((col2[0] === 'X' && col2[1] === 'X' && col2[2] === 'X') || (col2[0] === 'O' && col2[1] === 'O' && col2[2] === 'O')) {
        return true;
    }
    
    if ((col3[0] === 'X' && col3[1] === 'X' && col3[2] === 'X') || (col3[0] === 'O' && col3[1] === 'O' && col3[2] === 'O')) {
        return true;
    }
    ...
    if ((row2[0] === 'X' && row2[1] === 'X' && row2[2] === 'X') || (row2[0] === 'O' && row2[1] === 'O' && row2[2] === 'O')) {
        return true;
    }
    
    if ((row3[0] === 'X' && row3[1] === 'X' && row3[2] === 'X') || (row3[0] === 'O' && row3[1] === 'O' && row3[2] === 'O')) {
        return true;
    }
